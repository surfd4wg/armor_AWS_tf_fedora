...
#NEWprivatehostname="Fedora-$PRIVATE_IP-$AVAIL_ZONE-RedHat"
#NEWpublichostname="Fedora-$PUBLIC_IP-$AVAIL_ZONE-RedHat"
...
VarPRI="Fedora-$PRIVATE_IP-$AVAIL_ZONE"-"$INSTANCE_ID"
VarPUB="Fedora-$PUBLIC_IP-$AVAIL_ZONE"-"$INSTANCE_ID"
